        ...
        <div className="uk-flex uk-flex-column">
                                ...
                                }
                                {
                                    ...
                                    <td>
                                        <div className={classNames({"uk-button-group": true, "uk-align-right": !isMobile})}>
                                            ...
                                            {
                                                props.additionalActions && props.additionalActions.map((act, actIndex) => {
                                                    return (
            ...
            <div className="uk-column-1-2">
                ...
                <ul className="uk-pagination uk-flex-right">
                    ...
                    <span className="uk-text-lighter">Página { activePage + 1 } de { Math.ceil(items.length / props.itemsPerPage[0]) }</span>
