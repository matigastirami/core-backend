...
const MyProfile = (props) => {
    ...
    const handleModalAccept = async () => {
        if (action == 'CHANGE_PASSWORD') {
            ...
            try {
                let res = await userService.changePassword(localStorage._id, newPassword);
            ...
            <div className="uk-card uk-card-default uk-card-body uk-width-3-6">
                <form className="uk-form-horizontal">
                    ...
                    </div>
                    {
                        ...
                        <div>
                            <button className="uk-button uk-button-default uk-width-1-2" onClick={() => setEditProfileMode(!editProfileMode)}>
                        ...
                        <div>
                            <button className="uk-button uk-button-primary uk-width-1-1" onClick={() => setEditProfileMode(!editProfileMode)}>
